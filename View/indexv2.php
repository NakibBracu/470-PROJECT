...
<body>
    ...
    <div class="container">
        ...
        <a class="navbar-brand mr-auto" href="#"><img src="img/logo_FInal.png" height="30" width="41"></a>
	...
	<header class="jumbotron">
        <div class="container">
            <div class="row row-header" >
                <div class="col-12 col-sm-6" style="display:inline; background-color:black; width:100%">
                    <h1>Buffet Mania</h1>
                    <p>You can't find the best buffet other than us!!!.So, embark your delicious craving of food with us. </p>
                </div>
                <div class="col-12 col-sm align-self-center">
                    <img src="img/logo_FInal.png" class="img-fluid">
                </div>
                <div class="col-12 col-sm align-self-center">
...
<div class="container">
  ...
  <div class="carousel-inner">
    <div class="carousel-item">
      <img src="img/Nakib.jpeg" class="d-block" alt="...">
    ...
    <div class="carousel-item active">
      <img src="img/maxresdefault.jpg" class="d-block" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h2>Weekend Grand Buffet <span class="badge badge-danger">OFFER</span> <span class="badge badge-pill badge-default"></span></h2>
        <p>Mouthwatering foods are only avilable here! </p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="img/The-Buffet-King.jpg" class="d-block" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h2>MetaskaKourtuke<span class="badge badge-danger">NEW</span> <span class="badge badge-pill badge-default"></span></h2>
        <p>International foods from various parts of the world avilable here.</p>
      </div>
    </div>
  </div>
                        ...
                        <div class="card">
                                ...
                                <div class="collapse show" id="sakib" data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="d-none d-sm-block">
                                            Address: RoadNo.8A, HouseNo.8 Uttormoura<br>
                                            Manager: Rafsan the chotovai <br>
                            ...
                            <div class="card">
                                ...
                                <div class="collapse" id="sadman" data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="d-none d-sm-block">
                                            Address: Wireless Gate, Dhaka 1230<br>
        ...
        <div class="container">
            <div class="row">             
                ...
                <div class="col-7 col-sm-5">
                    ...
                    <address>
		             Address: RoadNo.8A, HouseNo.8 Uttormoura<br>
		              Near Haji Ansar Uddin Jame Masjid<br>
		              Bangladesh<br>
		              <i class="fa fa-phone fa-lg"></i>: +852 1234 5678<br>
		              <i class="fa fa-fax fa-lg"></i>: +852 8765 4321<br>
		              <i class="fa fa-envelope fa-lg"></i>: <a href="mailto:Buffetmania.net">Buffetmania.net</a>
		           </address>
                </div>
           ...
           <div class="row justify-content-center">             
                <div class="col-auto">
                    <p>© Copyright 2022 Buffet Mania</p>
                </div>
           </div>
        </div>
    </footer> 
